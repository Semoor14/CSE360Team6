...
public class QueueAnalyzerTest {
	...
	public void testOneElement()
	{
		...
		hand = analyzer.handFinder(queueToBeAnalyzed, queueToBeAnalyzed.length);
	...
	public void testIsRunOfThree()
	{
		...
		hand = analyzer.handFinder(queueToBeAnalyzed, analyzer.getNumElements(queueToBeAnalyzed));
