...
public class Place 
{
	...
	public static final int GS_QPROMPTBOX_YPOS = 160;
	...
	public static final int GS_REDEEMBUTTON_YPOS = 224;
	...
	public static final int GS_FINISHEDREDEEMBOX_XPOS = 248;
	public static final int GS_FINISHEDREDEEMBOX_YPOS = 96;
	public static final int GS_FINISHEDREDEEMBOX_WIDTH = 144;
	public static final int GS_FINISHEDREDEEMBOX_HEIGHT = 32;

	public static final int GS_WHOWONTHEGAMEBOX_XPOS = 248;
	public static final int GS_WHOWONTHEGAMEBOX_YPOS = 96;
	public static final int GS_WHOWONTHEGAMEBOX_WIDTH = 144;
	public static final int GS_WHOWONTHEGAMEBOX_HEIGHT = 64;

	// DiceHandler
	public static final int DH_DIE1BUTTON_XPOS = 248;
	public static final int DH_DIE2BUTTON_XPOS = 328;
	public static final int DH_DIEBUTTON_YPOS = 16;
